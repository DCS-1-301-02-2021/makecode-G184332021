...
let spacePlane = sprites.create(img`
     ...
     . . 1 1 1 . . . . . . . . . . .
     . . . 1 1 1 1 1 1 f . . . . . .
     . 2 2 2 1 1 1 f f f 4 4 4 4 4 4
     2 2 5 5 1 1 1 f 1 1 1 1 1 1 4 4
...
game.onUpdateInterval(500, function on_update() {
    let bogy = sprites.create(assets.image`スライムみたいなやつ`, SpriteKind.Enemy)
